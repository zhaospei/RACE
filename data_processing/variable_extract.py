...
def symbolic_tokenize(codes):
    ...
    for code in codes:
        ...
        # print(raw_line_len, preprocessed_line_len)
        # print(code)
        ...
        for line in code.splitlines():
            line_processed = " " + " ".join(w for w in nltk.word_tokenize(line)) +" "
                ...
                if t in keywords:
                    ...
                    if t in keywords:
                        ...
                        if t not in symbol_table.keys():
                            symbol_table[t] = "f" + str(f_count)
                            f_count += 1
                        final_tokens.append(symbol_table[t])
                        line_processed = line_processed.replace(" "+t+" ", " "+symbol_table[t]+" ")
                    idx += 1
